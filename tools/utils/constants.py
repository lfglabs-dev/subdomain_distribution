...
COMPILED_CONTRACTS_SIMPLE = [
    {"contract_name": "subdomain_distribution_SimpleSubdomainDistribution", "is_account_contract": False},
]

COMPILED_CONTRACTS_WHITELIST = [
    {"contract_name": "subdomain_distribution_Whitelist", "is_account_contract": False},
]
